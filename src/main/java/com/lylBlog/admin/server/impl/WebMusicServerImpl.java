...
import com.lylBlog.admin.mapper.WebMusicMapper;
 ...
 */
@Service
public class WebMusicServerImpl implements WebMusicServer {
    ...
    public ResultObj addOrUpdateMusicInfo(WebMusicBean webMusicBean, String type){
        ...
        //新增
        if("add".equals(type)){
            webMusicBean.setCreateBy(userBean.getId());//创建人id
            ...
            webMusicBean.setUpdateBy(userBean.getId());//修改人id
    ...
    public ResultObj uploadMusicFile(WebMusicBean webMusicBean){
        ...
        webMusicBean.setCreateBy(userBean.getId());
