...
public class MenuBean {
    private String F_ModuleId; //菜单id
    private String F_ParentId; //菜单上级id
    private String F_FullName; //菜单名称
    private String F_Icon; //菜单图标
    private String F_UrlAddress; //菜单路径
    private String F_Description; //描述
    private String F_CreateDate; //创建时间
    private String F_CreateUserId; //创建用户id
    private String F_CreateUserName; //创建用户名称
    private String F_ModifyDate; //修改时间
    private String F_ModifyUserId; //修改用户id
    private String F_ModifyUserName; //修改用户名称
